...
pc1 = calcekpca(data, 'KernelMethod', 'gaussian', 'GaussianSigma', '2', 'IsLabel', 'true', 'HealthyDataOnly', 'false', 'AllDataWithLabel', 'true', 'ExplainedVariance', '95', 'FirstNPCs', '', 'PlotXDim', 'PC1', 'PlotYDim', 'PC2');
