...
alpha = 1;  % alpha from 0 to 1. If alpha=1, it is a LASSO regression model. Otherwise, it is an elastic net regression model. If alpha is coloe to 0, it is a ridge regression model.
